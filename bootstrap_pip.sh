...
echo "=================================================="
echo "Bootstrap Script (pip-only) for Llama Epsilon Level Sets"
echo "=================================================="
...
echo ""
echo "To run on remote machine with SSH port forwarding:"
echo "  Local:  ssh -L 8888:localhost:8888 user@host"
echo "  Remote: source $ENV_NAME/bin/activate && jupyter lab --no-browser"
echo "  Then open the URL shown in your local browser"
echo ""
